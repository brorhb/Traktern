      ...
      <div class="books_bg">
        <div class="overlay">
          <div class="container-fluid">
            <div class="col-md-3"><a href="../loggetinn.html">
      ...
      <div class="col-sm-7">
        <div class="col-sm-12 box">
          <div class="col-sm-12">
            ...
            <h4>Fremgangsmåte</h4>
            <p>Lag en espresso i en kaffekopp som rommer 140ml, varm opp melken og hell den oppi koppen.</p><a href="video.php" class="btn btn-default pull-right">Neste</a><a href="../loggetinn.php" class="btn btn-default pull-left">Tilbake</a>
          </div>
        </div>
      </div>
