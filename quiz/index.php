      ...
      <div class="books_bg">
        <div class="overlay">
          <div class="container-fluid">
            <div class="col-md-3"><a href="http://136147-www.web.tornado-node.net">
                <p class="red"><-- Tilbake til Traktern.no</p></a>
              <h1>Velkommen</h1>
    ...
    <div class="container-fluid">
      <div class="col-sm-7 hidden-sm hidden-xs">
        <div class="col-sm-12 box">
          <div class="col-sm-3 hidden-sm hidden-xs"><img src="http://136147-www.web.tornado-node.net/wp-content/themes/laurels/images/kaffe.png" alt="kaffekopp" style="height:auto; width:100%; margin-top:32px;"></div>
          <div class="col-sm-9">
            <h3>Kaffe latte</h3>
